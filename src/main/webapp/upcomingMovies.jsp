...
<%
    ...
    List<Movie> umovies = md.getUpcomingMovies();
...
<div class="container">
    <div class="card-header my-3">Upcoming Movies</div>
    <div class="row">
        <%
            if (!umovies.isEmpty()){
                for (Movie m:umovies){
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h6 class="genre">Released: <%=m.getDateReleased()%></h6>
                    <h6 class="price"><%=m.getPrice()%></h6>
